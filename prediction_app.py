...
model= load_model('lstm_next_word_prediction_model.keras', compile= False) # Load the trained LSTM model from the specified file path without compiling it, as we will use it for prediction only
